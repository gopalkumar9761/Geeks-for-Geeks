<h2><a href="https://www.geeksforgeeks.org/problems/geek-in-a-maze--170637/1?_gl=1*147t94*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwtKrUBhAhEiwAr77ZoneCfsYQIhJ0-57bbJ5A-af5P1B1C9j8EXAxnWiLKXKRzrO7e2gJdRoCGBMQAvD_BwE&gbraid=0AAAAAC9yBkDXi1PAnrYNXB1H9RNrcfGxU">Geek in a Maze</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p data-start="571" data-end="632"><span style="font-size: 14pt;">Given a maze <strong>mat[][]</strong> of size<strong> n × m</strong>, where each cell is either:</span></p>
<ul>
