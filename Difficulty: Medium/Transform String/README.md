<h2><a href="https://www.geeksforgeeks.org/problems/transform-string5648/1?_gl=1*12oqyve*_up*MQ..*_gs*MQ..&gclid=CjwKCAjw7p_UBhBlEiwAhpIs7xMWHc9mvmPjTaHQ9QNWDichh4ERWqUsON2qeXPNC8aewx27CNGmSBoCXnIQAvD_BwE&gbraid=0AAAAAC9yBkCn0Lxf5EAdnXGsLijgaIwXa">Transform String</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two strings <strong>s1</strong> and <strong>s2</strong>. Find the minimum number of steps required to transform string s1 into string s2. The only allowed operation for the transformation is selecting a character from string s1 and inserting it in the beginning of string s1. </span></p>
