<h2><a href="https://www.geeksforgeeks.org/problems/buying-vegetables0016/1?_gl=1*18kdn4d*_up*MQ..*_gs*MQ..&gclid=CjwKCAjw48TUBhBREiwAK0GnQQEPtxhLze0N-DIRt9FBOA-3r15DPXoMn8ZDzcPDK-8aLzeOCo0lPRoC8x8QAvD_BwE&gbraid=0AAAAAC9yBkDxbmTML6FG8XgDu4LualdIK">Minimum Cost Selection</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an <strong>n × 3</strong> matrix <strong>mat[][]</strong>, where each row represents the costs of three available choices at a shop, </span><span style="font-size: 18px;">select exactly one choice from each row such that the same choice is not selected in two adjacent rows. </span></p>
